...
from generate_scenario.behavior_trajectory_solver.behavior_init import cut_in_init_position
...
def cut_in(network, road_type, ego_init, ego_dest, ego_speed, num, hazard_section):
    ...
    while rejection:
        ...
        if road_type != "straight road":
            npc_init_project_length, npc_init_lane, npc_dest_project_length = straight_behavior2intersection(network, road_type, hazard_section, "cut in", ego_init, ego_dest, npc_dest)
        else:
