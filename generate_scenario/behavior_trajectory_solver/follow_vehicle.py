...
from generate_scenario.behavior_trajectory_solver.behavior_init import follow_vehicle_init_position
...
def follow_vehicle(network, road_type, ego_init, ego_dest, ego_speed, num, hazard_section):
    ...
    while rejection:
        ...
        if road_type == "straight road":
            npc_init_project_length, npc_init_lane = straight_behavior2intersection(network, road_type, hazard_section, "follow vehicle", ego_init, ego_dest, npc_dest)
        else:
            npc_init_project_length, npc_init_lane = follow_vehicle_init_position(network, ego_init, npc_dest_project_length, ego_line_string, road_type)
