...
def combine_center_line(network, init_lane, dest_lane, road_type):
    forward = get_ego_next_lane(road_type)
...
if __name__ == '__main__':
    ...
    ego_line_string = combine_center_line(network, init_lane, dest_lane, "crossing")
